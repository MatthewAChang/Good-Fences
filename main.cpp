...
int main()
{
  convexHullFromFile("points/points1.txt", "images/out-hull_1.png");
  convexHullFromFile("points/points2.txt", "images/out-hull_2.png");
  convexHullFromFile("points/points3.txt", "images/out-hull_3.png");

  cout << "Convex hulls produced." << endl;

  intersectionFromFile("points/dept_1a.txt", "points/dept_1b.txt", "images/out-intersection_1.png");
  intersectionFromFile("points/dept_2a.txt", "points/dept_2b.txt", "images/out-intersection_2.png");
  intersectionFromFile("points/dept_3a.txt", "points/dept_3b.txt", "images/out-intersection_3.png");
